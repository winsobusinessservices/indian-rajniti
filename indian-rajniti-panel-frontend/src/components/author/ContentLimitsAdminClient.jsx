  ...
  return (
    <form onSubmit={save} className="space-y-6">
      <div className="rounded-lg border border-secondary/25 bg-secondary-fixed/45 px-4 py-3 font-body-md text-xs text-on-secondary-fixed">
        <i className="fa-solid fa-circle-info mr-2" aria-hidden="true" />Limits count content created from 12:00 AM to 11:59 PM each day. Administrators are not limited.
      </div>
