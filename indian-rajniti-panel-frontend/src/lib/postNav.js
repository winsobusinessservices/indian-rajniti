...
export const BACK_TARGETS = {
  history: { href: "/panel/history", label: "Back to Content History" },
  review: { href: "/panel/review", label: "Back to Review Queue" },
};
export const DEFAULT_BACK_TARGET = { href: "/panel/content", label: "Back to My Content" };
